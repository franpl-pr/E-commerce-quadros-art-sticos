...
function CadastroProduto(){
    ...
    return(
        <div className="dashboard" id="db-cadastro">
            <MenuLateral/>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="acoes">
                            <div className="add-img">
                                ...
                                <input type="file" id="image-input" accept="image/*" name="imagem" ref={inputFileRef}/>
                            </div>
            ...
            {notifSucesso && (
                <div className='box_notificacao_sucesso'>
                    <div className='notificacao_sucesso'>
                        <h1>Quadro cadastrado com sucesso!</h1>
                        <button onClick={() => navigate("/DashboardProdutos")}>Continuar</button>
                    </div>
                </div>
            )}
            {notifImagem && (
                <div className='box_notificacao_sucesso'>
                    <div className='notificacao_sucesso'>
                        <h1>Quadro Já cadastrado!</h1>
                        <button onClick={() => navigate("/DashboardProdutos")}>Ver o produto</button>
                        <button onClick={setNotifImagem(false)}>Cancelar</button>
                    </div>
                </div>
            )}
        </div>
