...
function Pagamento(){
    ...
    const handlePagamentoOption = (event) => {
        ...
        <div className="checkout_container">
            ...
            <SessaoCheckout/>
                ...
                <div className="checkout_div_cadastro_entrega">
                    <h2>Métodos de pagamento<div className="checkout_linha"/></h2>
                    <div className="acoes acoes-pagamento">
                
                            <div className="coluna-pagamento">
                                <div className="opcao-pagamento">
                                    <label>
                                        <input type='radio' name="opcao-pagamento" value="pix" onChange={handlePagamentoOption} checked={metodoPagamento === 'pix'}/>
                                        <span>Pix</span>
                                    </label>
                                </div>
                                <div className="opcao-pagamento">
                                    <label>
                                        <input type='radio' name="opcao-pagamento" value='debito' onChange={handlePagamentoOption} checked={metodoPagamento === 'debito'}/>
                                        <span>Debito</span>
                                    </label>
                                </div>
                            </div>
                            <div className="coluna-pagamento">
                                <div className="opcao-pagamento">
                                    <label>
                                        <input type='radio' name="opcao-pagamento" value='boleto' onChange={handlePagamentoOption} checked={metodoPagamento === 'boleto'}/>
                                        <span>Boleto</span>
                                    </label>
                                </div>
                                <div className="opcao-pagamento">
                                    <label>
                                        <input type='radio' name="opcao-pagamento" value='credito' onChange={handlePagamentoOption} checked={metodoPagamento === 'credito'}/>
                                        <span>Credito</span>
                                    </label>
                                </div>
                            </div>
